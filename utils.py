...
def parse_dataset_args(parser):
    ...
    parser.add_argument("--inter_file", type=str, default=".inter.json", help="the item indices file")
    ...
    #                     help="whether use slide window to augment training data")
...
def parse_train_args(parser):
    ...
    parser.add_argument("--ul_alpha", type=float, default=1.0)
    parser.add_argument("--head_items", type=str, default="./data/Instruments/Instruments.inter.json")
    parser.add_argument("--embed_file", type=str, default="./data/Instruments/Instruments.item.qwen2.5_3b.test.pt")
    parser.add_argument("--negative_k", type=int, default=5)
...
def parse_test_args(parser):
    ...
    parser.add_argument("--head_items", type=str, default="./data/Instruments/hot_items.json", help="path to hot item file")
    parser.add_argument("--tail_items", type=str, default="./data/Instruments/cold_items.json", help="path to cold item file")
...
def load_datasets(args):
    ...
    for task, prompt_sample_num,data_sample_num in zip(tasks,train_prompt_sample_num,train_data_sample_num):
        if task.lower() == "seqrec":
            ...
            #     dataset = SeqRecDataset(args, mode="train", prompt_sample_num=prompt_sample_num, sample_num=data_sample_num, slide_window=True)
            # else:
